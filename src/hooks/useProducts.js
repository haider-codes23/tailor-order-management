...
export function useCreateBOM() {
  ...
  return useMutation({
    mutationFn: ({ productId, bomData }) =>
      productsApi.createBOM(productId, bomData),
    onSuccess: (data, variables) => {
...
export function useUpdateBOM() {
  ...
  return useMutation({
    mutationFn: ({ bomId, updates }) =>
      productsApi.updateBOM(bomId, updates),
    onSuccess: (data) => {
      const bom = data.data;
...
export function useUpdateBOMItem() {
  ...
  return useMutation({
    mutationFn: ({ bomId, itemId, updates }) =>
